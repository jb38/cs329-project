        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <?php
              ...
              $sql = "select id, name, latitude, longitude from stop order by id";
   
              $stmt = $pdo->query($sql);
  
              while($row = $stmt->fetch()) {
                
                echo("<tr data-id='" . $row["id"] . "'><td>" . $row["id"] . "</td><td>" . $row["name"]  . "</td><td>" . $row["latitude"] . "</td><td>" . $row["longitude"] . "</td><td>");
