<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $sql = "update trip set rider_id = :rider_id, entry_datetime = :entry_datetime, exit_datetime = :exit_datetime, entry_stop = :entry_stop, exit_stop = :exit_stop, cost = :cost where id = :id";
      ...
      <div class="col-sm-12">
        ...
        <form class="form form-horizontal" method="POST" action="edit.php">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <input class="form-control" type="text" name="name" value="<?php echo($row["rider_id"]); ?>">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <input class="form-control" type="text" name="entry_datetime" value="<?php echo($row["entry_datetime"]); ?>">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <input class="form-control" type="text" name="exit_datetime" value="<?php echo($row["exit_datetime"]); ?>">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <input class="form-control" type="text" name="entry_stop" value="<?php echo($row["entry_stop"]); ?>">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <input class="form-control" type="text" name="exit_stop" value="<?php echo($row["exit_stop"]); ?>">
              </div>
            </div>
